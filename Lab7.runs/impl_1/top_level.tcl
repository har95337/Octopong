...
set rc [catch {
  ...
  add_files -quiet C:/Users/hsingh18/Desktop/Lab7_Done.xpr/Lab7/Lab7.runs/synth_1/top_level.dcp
...
set rc [catch {
  ...
  report_drc -file top_level_drc_routed.rpt -pb top_level_drc_routed.pb -rpx top_level_drc_routed.rpx
  report_methodology -file top_level_methodology_drc_routed.rpt -rpx top_level_methodology_drc_routed.rpx
...
set rc [catch {
  ...
  write_bitstream -force -no_partial_bitfile top_level.bit 
